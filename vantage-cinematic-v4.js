...
addFilmFrames($('.hero'));addFilmFrames($('.aria'));addFilmFrames($('.humacity'));addFilmFrames($('.record'));addFilmFrames($('.meridian'));addFilmFrames($('.sim-room'));addFilmFrames($('.pricing-block'));
